<template>
    ...
    >
      ...
      >
        <img width="36px" src="/assets/icons/pokemon-fav-active.svg" alt="Fav Icon Active" v-if="isFavorite" />
        <img width="36px" src="/assets/icons/pokemon-fav-disabled.svg" alt="Fav Icon Inactive" v-else />
      </button>
    </div>
</template>
